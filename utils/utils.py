...
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    ...
    #listDet = ['person', 'bicycle', 'car', 'motorbike', 'bus', 'truck', 'bird', 'cat', 'dog', 'horse', 'cow',
     #          'backpack', 'umbrella', 'handbag', 'kite', 'cell phone']
    # print('curr : ' + str(label))

    listDet = ['bee','spider','ladybird','dragon','caterpillar','butterfly']
